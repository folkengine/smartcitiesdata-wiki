...
See [reaper name](https://github.com/Datastillery/smartcitiesdata/wiki/Names#reaper) explained.
...
The [forklift name](https://github.com/Datastillery/smartcitiesdata/wiki/Names#forklift) explained.
