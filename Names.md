...
## [Andi](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/andi)
...
## Discovery [API](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/discovery_api)/[Streams](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/discovery_streams)/[UI](https://github.com/UrbanOS-Public/react_discovery_ui)
...
Discovery UI should be wrapped in some kind of branding. As an example, Columbus uses [this repo](https://github.com/UrbanOS-Public/react_discovery_ui) as its brand wrapper

## [Divo](https://github.com/UrbanOS-Public/divo)
...
## [Forklift](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/forklift)
...
## [KDP](https://github.com/UrbanOS-Public/kdp)
...
## [Odo](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/odo)
...
## [Prestige](https://github.com/UrbanOS-Public/prestige)
...
## [Reaper](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/reaper)
...
## [Smart City](https://github.com/UrbanOS-Public/smart_city)
...
## [Smart City Test](https://github.com/UrbanOS-Public/smart_city_test)

A library developed specifically for standardizing the testing process of the various platform microservices.

## [Streaming Metrics](https://github.com/UrbanOS-Public/streaming_metrics)
...
## [Valkyrie](https://github.com/UrbanOS-Public/smartcitiesdata/tree/master/apps/valkyrie)
